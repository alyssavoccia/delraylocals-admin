  ...
  return (
    <section className="pl-[80px] pr-4">
      <div className="flex justify-between items-center">
        <h1 className="py-4 font-black text-2xl">Living</h1>
        <button className="bg-slate-500 hover:bg-slate-400 transition-all text-white font-semibold p-2 rounded flex justify-center w-[150px]">Add Living</button>
        <DiningModal />
      </div>
      <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-4">
        {currLiving.map(living => (
          <div key={living} className="flex justify-between items-center" id={living}>
            <div>
              Living
            </div>
